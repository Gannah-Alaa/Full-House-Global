...
{
    $DelId=$_GET['delete'];
    $delete=" DELETE FROM `events` WHERE `EventId`=$DelId";
    ...
    <main >
        ...
        <div class="container tabs">
            <ul class="nav nav-pills justify-content-center mb-3 gap-3" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation"><a href="AdminPortfolio.php">
                ...
                <li class="nav-item" role="presentation"><a href="AdminPortfolio.php?categories=<?php echo $categ['CatId']?>">
                            ...
                            <div class="event-block position-relative">
                                    ...
                                    <div class="event-description">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <a href="EditEvent.php?edit=<?php echo $data['EventId']; ?>">EDIT</a>
                                            <a href="AdminPortfolio.php?delete=<?php echo $data['EventId']; ?>">DELETE</a>
                                        </div>
                                    </div>
                                </div>
                            </a>
